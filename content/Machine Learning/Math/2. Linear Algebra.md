...
![[Pasted image 20260425185658.png]]
...
- Can calculate the inverse using Gaussian Elimination
	- $[A \vert I]$  -> $[I \vert A^-1]$
* Inverse for a 2x2:
![[Pasted image 20260425185706.png]]
...
> 
> If we want to find that $$
\begin{aligned}
\vec{v}=\begin{bmatrix} 1 \\ 2 \\ 0 \end{bmatrix}
\end{aligned}
$$ in the span of $$
\begin{aligned}
S = \{\begin{bmatrix} 1 \\ 1 \\ 0 \end{bmatrix}, \begin{bmatrix} 1 \\ 1 \\ 7 \end{bmatrix}\}
\end{aligned}
$$, we can just look at the rank of
> $$
\begin{aligned}
\begin{bmatrix} 1 && 1 && 1 \\ 1 && 1 && 2 \\ 0 && 7 && 0 \end{bmatrix}
\end{aligned}
$$
...
![[Pasted image 20260425185732.png|525]]
...
![[Pasted image 20260425185746.png|498]]

> **Tip:** SVD can be used for dimensionality reduction or compression.

$$A = U\varepsilon V^T$$

$$A^TA = (U\varepsilon V^T)U\varepsilon V^T$$

$$A^TA = V\varepsilon^T U^TU\varepsilon V^T$$

$$A^TA = V\varepsilon^T \varepsilon V^T$$

$$A^TA = V\varepsilon^2 V^T$$

or,

$$AA^T = U\varepsilon^2 U^T$$
