...
- [ ] ==How are embeddings calculated? (Implement word2vec, skip-gram, Cont.-bag-of-words, GloVe)==
- [ ] ==Train an embedding model (how are weights trained?, related: word2vec embeddings)==
- [ ] ==RNN (also, BiDirectional RNNs) & LSTM from scratch==
- [ ] Byte-pair-encoding (subword tokenization algorithm)
